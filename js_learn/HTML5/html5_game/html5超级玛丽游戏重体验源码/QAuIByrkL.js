...
Mario.MapState.prototype.Draw = function (a) {
    ...
    if (this.WorldNumber !== 8) {
        ...
        } else if (this.Level[b][c] === Mario.MapTile.Decoration)this.DecoSprite.X = b * 16, this.DecoSprite.Y = c * 16, this.DecoSprite.Draw(a, this.camera); else if (this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] === -2)this.HelpSprite.X = b * 16 + 16, this.HelpSprite.Y = c * 16 - 16, this.HelpSprite.Draw(a, this.camera);
