...
import (
	module "arithmetic_circuitbreaker_demo/gateway/module"
	"flag"
	"fmt"
	"net"
	"net/http"
...
func main() {
	...
	// 创建环境变量
	var (
		consulHost = flag.String("consul.host", "172.20.10.8", "consul server ip address")
	...
	hystrixRouter := module.Routes(consulClient, zipkinTracer, "Circuit Breaker:Service unavailable", logger)
