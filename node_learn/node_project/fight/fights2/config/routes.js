...
module.exports = function (app) {
    ...
    //电影编辑页
    app.get('/admin/movie/edit', User.signinRequired, User.adminRequired, Movie.movieEdit);
    ...
    //电影分类页面
    app.get('/admin/movie/category', Category.categoryEdit );
    app.post('/admin/movie_category/new', Category.movieCategorySave);
